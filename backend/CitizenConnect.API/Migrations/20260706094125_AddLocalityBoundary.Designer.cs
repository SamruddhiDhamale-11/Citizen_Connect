...
namespace CitizenConnect.API.Migrations
{
    ...
    [Migration("20260706094125_AddLocalityBoundary")]
    partial class AddLocalityBoundary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.FacilityData", b =>
                {
                    ...
                    b.Property<int>("FacilityRecordId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FacilityRecordId", "FacilityFieldId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.FacilityRecord", b =>
                {
                    b.Property<int>("FacilityRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FacilityRecordId"));
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.LocalityBoundary", b =>
                {
                    b.Property<int>("LocalityBoundaryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LocalityBoundaryId"));
                    ...
                    b.HasKey("LocalityBoundaryId");

                    b.HasIndex("LocalityId")
                        .IsUnique();

                    b.ToTable("LocalityBoundaries");
                });

            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.Ward", b =>
                {
                    b.Property<int>("WardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("JurisdictionId", "WardNumber")
                        .IsUnique();

                    b.ToTable("Wards");
                });

            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.WardRepresentative", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CitizenConnect.Domain.Entities.Complaint", b =>
                {
                    ...
                    b.Property<bool>("IsAssignedEmailSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CitizenConnect.Domain.Entities.WardBoundary", b =>
                {
                    b.Property<int>("WardBoundaryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WardBoundaryId"));
                    ...
                    b.HasKey("WardBoundaryId");

                    b.HasIndex("WardId");

                    b.ToTable("WardBoundaries");
                });
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.Demographic", b =>
                {
                    ...
                    b.HasOne("CitizenConnect.API.Domain.Entities.Ward", "Ward")
                        .WithMany("Demographics")
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.FacilityData", b =>
                {
                    ...
                    b.HasOne("CitizenConnect.API.Domain.Entities.FacilityModule", null)
                        .WithMany("FacilityDatas")
                        .HasForeignKey("FacilityModuleId");

                    b.HasOne("CitizenConnect.API.Domain.Entities.FacilityRecord", "FacilityRecord")
                        .WithMany("FacilityDatas")
                    ...
                    b.HasOne("CitizenConnect.API.Domain.Entities.Ward", null)
                        .WithMany("FacilityDatas")
                        .HasForeignKey("WardId");
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.LocalityBoundary", b =>
                {
                    b.HasOne("CitizenConnect.API.Domain.Entities.Locality", "Locality")
                        .WithOne("LocalityBoundary")
                        .HasForeignKey("CitizenConnect.API.Domain.Entities.LocalityBoundary", "LocalityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.Ward", b =>
                {
                    ...
                    b.HasOne("CitizenConnect.Domain.Entities.JurisdictionType", null)
                        .WithMany("Wards")
                        .HasForeignKey("JurisdictionTypeId");
            ...
            modelBuilder.Entity("CitizenConnect.API.Domain.Entities.Ward", b =>
                {
                    ...
                    b.Navigation("WardBoundaries");

                    b.Navigation("WardDepartments");

                    b.Navigation("WardRepresentatives");
                });
